...
def test_box_office_metrics_fetch_length(test_provider, test_paths):
...
def test_box_office_metrics_fetch_titles(test_provider, test_paths):
    domestic, financials, international = test_provider.fetch(test_paths)
...
def test_box_office_metrics_fetch_missing_file(test_provider, test_paths):
...
def test_box_office_metrics_fetch_file_unreadable(test_provider, test_paths):
...
def test_box_office_metrics_fetch_empty_file(test_provider, test_paths):
...
def test_box_office_metrics_transform_titles(test_provider, test_data):
...
def test_box_office_metrics_transform_preserves_row_count(test_provider, test_data):
    processed = test_provider.transform(test_data)
    assert len(processed) == 3


def test_box_office_metrics_transform_schema_mapping(test_provider, test_data):
    processed = test_provider.transform(test_data)
...
def test_box_office_metrics_transform_messy_data(test_provider, test_data):
...
def test_box_office_metrics_transform_missing_key_attribute(test_provider, test_data):
    domestic, financials, international = test_data
...
def test_box_office_metrics_integration_pipeline(test_provider, test_paths):
...
def test_box_office_metrics_integration_messy_file(test_provider, tmp_path, test_paths):
